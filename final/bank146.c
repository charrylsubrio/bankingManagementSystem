...
void sortClients() {
    ...
    printf("\t\t\t\t\t\t\t========== SORT CLIENTS ==========\n\n");
    printf("\t\t\t\t\t\t\t[1] - By Name (Ascending)\n");
    printf("\t\t\t\t\t\t\t[2] - By Balance (Ascending)\n");
    printf("\t\t\t\t\t\t\t[3] - By Name (Descending)\n");
    printf("\t\t\t\t\t\t\t[4] - By Balance (Descending)\n");
    printf("\n\t\t\t\t\t\t\tPlease enter your choice: ");
    scanf("%d", &choice);
    ...
    for (int i = 0; i < clientCount - 1; i++) {
        for (int j = i + 1; j < clientCount; j++) {
            if ((choice == 1 && strcmp(clients[i].name, clients[j].name) > 0) ||  // Name Ascending
                (choice == 2 && clients[i].balance > clients[j].balance) ||      // Balance Ascending
                (choice == 3 && strcmp(clients[i].name, clients[j].name) < 0) ||  // Name Descending
                (choice == 4 && clients[i].balance < clients[j].balance)) {       // Balance Descending
...
void viewTransacHist() {
	...
	printf("\t\t\t\t\t\t\t= VIEW CLIENT TRANSACTION HISTORY =\n\n");
